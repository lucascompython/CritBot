...
class CritHelpCommand(commands.DefaultHelpCommand):
    ...
    async def send_command_help(self, command: commands.Command[Any, ..., Any], /) -> Optional[list[str]]:
        self.add_command_formatting(command)
        self.paginator.close_page()
        if self.slash: return self.paginator.pages
